...
/**  Funzione che inizializza il giocatore gli alieni e i proiettili, la funzione riceve gli input dell'utente per gestire il movimento della navicella del player e quando essa spara, mentre gli alieni si muovono sempre seguendo la stessa logica e sparando bombe usando valori e possibilita casuali.
   *@param *punteggio è il punteggio che viene passato da main questo valore viene passato poi in un altra
   *@param *vincita è la variabile che determina la vincita o la sconfitta in base al valore che assume
   *@param *punteggioMax è il punteggio massimo raggiunto dal giocatore usato per una stampa schermo
   *@param *opzioni_generali questa variabile viene presa dalla funzione movimenti per gestire i delay tra una parte di codice e un'altra modificando così la velocità di gioco generale 
   *@param *opzioni_alieni questa variabile viene presa dalla funzione movimenti per gestire i delay tra una parte di codice e un'altra modificando così la velocità degli alieni 
   *@param *opzioni_proiettili questa variabile viene presa dalla funzione movimenti per gestire i delay tra una parte di codice e un'altra modificando così la velocità dei proiettili della navicella 
   *@param *opzioni_bombe questa variabile viene presa dalla funzione movimenti per gestire i delay tra una parte di codice e un'altra modificando così la velocità di lancio delle bombe da parte degli alieni
   *@param *opzioni_casualitaBomba questa variabile viene presa dalla funzione movimenti per gestire i delay tra una parte di codice e un'altra modificando così la frequenza di lancio delle bombe da parte degli alieni
*/
